...
STRINGS: dict[str, dict[str, str]] = {
    LANG_EN: {
        ...
        "status_waiting_outlook": "Paused — waiting for Outlook to recover (restart Outlook if needed)...",
        "status_outlook_resumed": "Outlook reconnected — resuming export...",
    ...
    LANG_HU: {
        ...
        "status_waiting_outlook": "Szünet — várakozás az Outlookra (indítsa újra, ha kell)...",
        "status_outlook_resumed": "Outlook újracsatlakozott — export folytatása...",
